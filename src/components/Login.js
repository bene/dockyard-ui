                ...
                <Navbar color="dark" dark expand="md" className="p-3 shadow">
                    <Container>
                        ...
                        <Collapse isOpen={ this.state.isOpen } navbar>
                            <Nav navbar>
                                <NavItem>
                                    <NavLink target="_blank" href="https://github.com/bene/dockyard-server">Github</NavLink>
                                </NavItem>
                            </Nav>
                ...
                <Jumbotron className="bg-white shadow">
                    ...
                    <Form onSubmit={ this.submit }>
                        <FormGroup>
                            ...
                            <Input type="text" value={ this.state.identifier } onChange={(e) => this.setState({ identifier: e.target.value })} placeholder="Enter your username or email" required />
                        </FormGroup>

                        <FormGroup>
                            <Label>Password</Label>
                            <Input type="password" value={ this.state.password } onChange={(e) => this.setState({ password: e.target.value })} placeholder="Enter your password" required />
                        </FormGroup>
                    ...
                    <Jumbotron className="bg-white shadow">
                        <Form onSubmit={ this.submit }>
                            <FormGroup>
                                ...
                                <Input type="text" value={ this.state.username } onChange={(e) => this.setState({ username: e.target.value })} placeholder="Pick a username" required />
                            </FormGroup>

                            <FormGroup>
                                <Label>Email</Label>
                                <Input type="email" value={ this.state.email } onChange={(e) => this.setState({ email: e.target.value })} placeholder="you@example.com" required />
                            </FormGroup>

                            <FormGroup>
                                <Label>Password</Label>
                                <Input type="password" value={ this.state.password } onChange={(e) => this.setState({ password: e.target.value })} placeholder="Enter a password" required />
                            </FormGroup>
